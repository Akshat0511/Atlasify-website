    ...
    const fetchAllResources = async () => {
      ...
      try {
        const [roadmapData, projectsData, articlesData, ytData, ghData] =
          await Promise.all([
            safeFetch("https://backend-atlasify-website.vercel.app/api/roadmap", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body,
            }),
            safeFetch("https://backend-atlasify-website.vercel.app/api/projects", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body,
            }),
            safeFetch("https://backend-atlasify-website.vercel.app/api/articles", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body,
            }),
            safeFetch("https://backend-atlasify-website.vercel.app/api/youtube", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({ query: topic }),
            }),
            safeFetch("https://backend-atlasify-website.vercel.app/api/github", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({ query: topic }),
            }),
